...
namespace Tests.testcases.about
{
    public class aboutTestCase : testcase
    {
        ...
        {
            spritebatch.Draw(pixel, new Rectangle(0, 0, (int)(int)Sh.Framework.Graphics.ShWindow.getWidth(), (int)Sh.Framework.Graphics.ShWindow.getHeight()), Color.DarkSlateGray);
